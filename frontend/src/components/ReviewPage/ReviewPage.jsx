              ...
              return (
                <div key={index} className="answer-card">
                  <div className="question-header">
                    ...
                    <span className={`attempt-status ${selectedOption !== undefined && selectedOption !== null && selectedOption !== '' && selectedOption !== 'Not Answered' ? 'attempted' : 'not-attempted'}`}>
                      {selectedOption !== undefined && selectedOption !== null && selectedOption !== '' && selectedOption !== 'Not Answered' ? 'Attempted' : 'Not Attempted'}
                    </span>
                  </div>
                  ...
                  <div className="options-list">
                    {question.options.map((option, optIndex) => (
                      <div
                        key={optIndex}
                        className={`option ${optIndex === selectedOption ? 'student-answer' : ''}`}
                      >
